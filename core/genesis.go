...
func DefaultGenesisBlock() *Genesis {
	...
	amt, err := new(big.Int).SetString("1000000000000000000000000",10)
	if err {
		amt=big.NewInt(100000)
	}
	return &Genesis{
...
func DefaultDevnetGenesisBlock() *Genesis {
	devAddress := common.HexToAddress("0xe5c8029fdA4AB84fc8f48DB410C8373a7345764f")
	faucet := common.HexToAddress(" 0x533dbAEF28d9ac53673238eB4C2d8556278F33Ff")
	amt, err := new(big.Int).SetString("1000000000000000000000000",10)
	if err {
		amt=big.NewInt(100000)
	}
