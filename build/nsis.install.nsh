...
!define HELPURL "https://github.com/fgeth/fgeth/issues"
!define UPDATEURL "https://github.com/fgeth/fgeth/releases"
!define ABOUTURL "https://github.com/fgeth/fgeth#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\fgeth.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\fgeth.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:30300)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:30300)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:30300)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30300)" ""  6 1 1 2147483647 1 "$INSTDIR\fgeth.exe" "" "" "Ethereum" 30300 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30300)" ""  6 2 1 2147483647 1 "$INSTDIR\fgeth.exe" "" "" "Ethereum" "" 30300 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30300)" "" 17 2 1 2147483647 1 "$INSTDIR\fgeth.exe" "" "" "Ethereum" "" 30300 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\fgeth.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\fgeth.ipc"
